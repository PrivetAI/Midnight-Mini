...
enum Catalog {
    ...
    static let all: [ProductLine] = [
        ...
        ProductLine(id: 3, name: "Candy",      glyph: .candy,     color: MarketTheme.neonPink,   basePrice: 5,  restockCost: 2,  unlockNight: 1),
        ...
        ProductLine(id: 6, name: "Ice Cream",  glyph: .iceCream,  color: MarketTheme.neonPink,   basePrice: 22, restockCost: 8,  unlockNight: 4),
        ProductLine(id: 7, name: "Batteries",  glyph: .batteries, color: MarketTheme.neonCyan,   basePrice: 25, restockCost: 9,  unlockNight: 5),
        ProductLine(id: 8, name: "Energy",     glyph: .energy,    color: MarketTheme.neonGreen,  basePrice: 30, restockCost: 11, unlockNight: 6),
        ProductLine(id: 9, name: "Lotto",      glyph: .lottery,   color: MarketTheme.neonViolet, basePrice: 40, restockCost: 14, unlockNight: 7),
        ProductLine(id: 10, name: "Hot Dog",    glyph: .hotDog,    color: MarketTheme.neonAmber,  basePrice: 16, restockCost: 6,  unlockNight: 8),
        ProductLine(id: 11, name: "Slushie",    glyph: .slushie,   color: MarketTheme.neonCyan,   basePrice: 14, restockCost: 5,  unlockNight: 9),
        ProductLine(id: 12, name: "Flowers",    glyph: .flowers,   color: MarketTheme.neonPink,   basePrice: 28, restockCost: 10, unlockNight: 10),
        ProductLine(id: 13, name: "Charger",    glyph: .charger,   color: MarketTheme.neonGreen,  basePrice: 35, restockCost: 13, unlockNight: 11),
        ProductLine(id: 14, name: "Plushie",    glyph: .plushie,   color: MarketTheme.neonViolet, basePrice: 45, restockCost: 16, unlockNight: 12),
        ProductLine(id: 15, name: "Water",      glyph: .water,     color: MarketTheme.neonCyan,   basePrice: 8,  restockCost: 3,  unlockNight: 13),
        ProductLine(id: 16, name: "Donut",      glyph: .donut,     color: MarketTheme.neonAmber,  basePrice: 12, restockCost: 4,  unlockNight: 14),
        ProductLine(id: 17, name: "Gum",        glyph: .gum,       color: MarketTheme.neonPink,   basePrice: 6,  restockCost: 2,  unlockNight: 15),
        ProductLine(id: 18, name: "Newspaper",  glyph: .newspaper, color: MarketTheme.neonViolet, basePrice: 10, restockCost: 3,  unlockNight: 16),
        ProductLine(id: 19, name: "Umbrella",   glyph: .umbrella,  color: MarketTheme.neonGreen,  basePrice: 26, restockCost: 9,  unlockNight: 17)
    ]
